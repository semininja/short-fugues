...
piece = "No. 2 in D minor, BWV 554"
title = "Prelude & Fugue No. 2 in D minor"
subtitle = "BWV 554"
...
corfug = {
  \relative f' {
    ...
    \cueDuring "tpt" #UP { \partial 8*5 r8 r2 |
    R1 | }
    r2 r4 r8 d |
    c e b e a, c f4 |
